...
from gym_carla.multi_lane.util.misc import get_speed, is_within_distance, get_trafficlight_trigger_location, \
    compute_distance
...
class BasicAgent(object):
    ...
    def __init__(self, vehicle, opt_dict={}):
        ...
        self._vehicle_controller = VehiclePIDController(self._vehicle, args_lateral=self._args_lateral_dict,
                                                        ...
                                                        offset=self._offset, max_throttle=self._max_throt,
